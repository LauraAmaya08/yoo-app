...
const SizeBox = {
    BOX_L: 'w-[350px] h-[500px] md:h-[550px] md:w-[450px] lg:w-[78%] xl:h-[570px] min-w-[260px] min-h-[500px] max-w-[1220px]',
    BOX_R: 'w-[350px] h-[500px] lg:w-[700px] min-w-[390px] lg:max-w-full lg:h-auto',
}
...
export{Size,SizeBox,Backgrounds}